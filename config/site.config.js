...
module.exports = {
  ...
  icon: '/icons/32.jpg', // or icon: '/icons/128.png', to use a image.
  ...
  footer:
  'Powered by <a href="https://onedrive.live.com/" target="_blank" rel="noopener noreferrer">onedrive</a>, 本页面借助 <a href="https://github.com/dahisea/onedrive-index" target="_blank" rel="noopener noreferrer">onedrive-index</a> by iRedScarf 构建',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/iRedScarf',
    },
  ],
